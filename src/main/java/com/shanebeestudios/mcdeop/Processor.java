...
import com.shanebeestudios.mcdeop.remapper.MainRemapper;
...
public class Processor {
    ...
    public void remapJar() {
        ...
        if (!REMAPPED_JAR.exists()) {
            MainRemapper.remap(JAR_FILE, MAPPINGS_FILE, REMAPPED_JAR);

            long finish = Duration.ofMillis(System.currentTimeMillis() - start).getSeconds();
            Logger.info("Remapping completed in %s seconds", finish);
        } else {
